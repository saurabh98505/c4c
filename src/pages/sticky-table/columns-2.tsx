...
export const COLUMNS = [
    ...
    // //end
    {
        Header: 'Austausch des Werbeelementes empfohlen',
        Footer: 'Austausch des Werbeelementes empfohlen',
        accessor: 'austauschDesColumn',
    },
    {
        Header: 'Layout',
        Footer: 'Layout',
        accessor: 'layoutColumn',
    },
    {
        Header: 'RTG Werbung',
        Footer: 'RTG Werbung',
        accessor: 'rtgWarbungColumn',
    },
    {
        Header: 'Markmale Kontur Beleuchtung',
        Footer: 'Markmale Kontur Beleuchtung',
        accessor: 'merkmaleTankdachColumn',
    },
    {
        Header: 'Markmale Kontur',
        Footer: 'Markmale Kontur',
        accessor: 'markmaleKonturList',
    },
    {
        Header: 'Markmale Kontur UK',
        Footer: 'Markmale Kontur UK',
        accessor: 'markmaleKonturUkList',
    },
